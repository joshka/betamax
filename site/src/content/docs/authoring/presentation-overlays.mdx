...
Add captions to explain a step and keyboard labels to show keys such as arrows or shortcuts.
These overlays appear in recordings and screenshots without changing the terminal session.
