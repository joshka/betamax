...
mise tools because package verification builds `libghostty-vt-sys`, which requires Zig 0.15.2 until
the upstream Ghostty build supports newer Zig releases.
